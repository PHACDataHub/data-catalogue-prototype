/*
This script populates the content on the data dictionary page in both French and English.
It also builds the HTML data table based on data/dictionary.csv
